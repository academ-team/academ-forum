...
# System config
use constant ADMIN_PASS => 'AZAZAZAZ';			# Admin password. For fucks's sake, change this.
use constant NUKE_PASS => 'OLOLOLOLOLO';			# Password to nuke a board. Change this too, NOW!
use constant SECRET => 'sadf;jkn;dpiupuaidsnpfunpuanfkjnalkjnlfjalnskjdfnljsadnfsaunfosiunflasjnfljanljkfnlasjknfljsanlfkjsnlkfjnalksjnflakjsdnflakjdsnivunapduvnpaiudvnpaiusdnvpiajsnflkjnflaskjnfasd';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'Набожный форум, посвященный мирским невзгодам';	# Name of this image board
...
# Limitations
use constant MAX_KB => 50000;					# Maximum upload size in KB
...
use constant MAX_RES => 1000000;					# Maximum topic bumps
...
#use constant IMG_DIR => '/mnt/share/board/src/';				# Image directory (needs to be writeable by the script)
#use constant THUMB_DIR => '/mnt/share/board/thumb/';			# Thumbnail directory (needs to be writeable by the script)
#use constant RES_DIR => '/mnt/share/board/res/';				# Reply cache directory (needs to be writeable by the script)
